...
var BTChip = Class.create({
  ...
  getRemainingPinAttempts_async : function() {
    var that = this;
    return this.card.sendApdu_async(0xe0, 0x22, 0x80, 0x00, new ByteString("00", HEX)).then(function(result) {
      console.log("SW=", result);
      return that.card.SW - 0x63C0;
    })
  },
